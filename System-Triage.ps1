...
<div id="toolsView" class="view"><div class="spec-section"><h2>Diagnostics &amp; Monitoring</h2><div class="drive-grid"><a class="drive tool-card" href="https://www.hwinfo.com/download/" target="_blank" rel="noopener"><h3>HWiNFO</h3><div class="sub" style="line-height:1.5">Real-time hardware sensor monitoring &mdash; temperatures, voltages, clock speeds, fan speeds.</div></a><a class="drive tool-card" href="https://www.cpuid.com/softwares/cpu-z.html" target="_blank" rel="noopener"><h3>CPU-Z</h3><div class="sub" style="line-height:1.5">Quick reference for CPU, motherboard, and RAM specifications.</div></a><a class="drive tool-card" href="https://www.techpowerup.com/gpuz/" target="_blank" rel="noopener"><h3>GPU-Z</h3><div class="sub" style="line-height:1.5">CPU-Z's GPU-focused equivalent &mdash; driver version, VRAM, clocks, sensors.</div></a><a class="drive tool-card" href="https://crystalmark.info/en/software/crystaldiskinfo/" target="_blank" rel="noopener"><h3>CrystalDiskInfo</h3><div class="sub" style="line-height:1.5">Drive health and SMART status at a glance.</div></a><a class="drive tool-card" href="https://www.hdsentinel.com/" target="_blank" rel="noopener"><h3>HDSentinel</h3><div class="sub" style="line-height:1.5">Alternative drive health monitor with predictive failure estimates and more detailed SMART reporting.</div></a><a class="drive tool-card" href="https://www.resplendence.com/latencymon" target="_blank" rel="noopener"><h3>LatencyMon</h3><div class="sub" style="line-height:1.5">Measures system latency and DPC issues &mdash; the standard tool for diagnosing audio crackling and stuttering.</div></a></div></div><div class="spec-section"><h2>Stability &amp; Stress Testing</h2><div class="drive-grid"><a class="drive tool-card" href="https://www.memtest86.com/" target="_blank" rel="noopener"><h3>MemTest86</h3><div class="sub" style="line-height:1.5">Bootable RAM stability test, run outside Windows &mdash; the standard way to confirm or rule out bad memory.</div></a><a class="drive tool-card" href="https://www.ocbase.com/" target="_blank" rel="noopener"><h3>OCCT</h3><div class="sub" style="line-height:1.5">Combined CPU/GPU/RAM stress test with built-in stability and error detection.</div></a><a class="drive tool-card" href="https://geeks3d.com/furmark/" target="_blank" rel="noopener"><h3>FurMark</h3><div class="sub" style="line-height:1.5">GPU stress test &mdash; useful for spotting thermal throttling or instability under sustained load.</div></a></div></div><div class="spec-section"><h2>Crash Analysis</h2><div class="drive-grid"><a class="drive tool-card" href="https://www.resplendence.com/whocrashed" target="_blank" rel="noopener"><h3>WhoCrashed</h3><div class="sub" style="line-height:1.5">Plain-English analysis of minidump files &mdash; pairs directly with the .dmp files this tool collects.</div></a><a class="drive tool-card" href="https://learn.microsoft.com/en-us/windows-hardware/drivers/debugger/debugger-download-tools" target="_blank" rel="noopener"><h3>WinDbg</h3><div class="sub" style="line-height:1.5">Microsoft's own debugger &mdash; a more advanced tool for reading minidumps in full detail, down to the exact stack trace.</div></a></div></div><div class="spec-section"><h2>Advanced System Tools</h2><div class="drive-grid"><a class="drive tool-card" href="https://learn.microsoft.com/en-us/sysinternals/downloads/process-explorer" target="_blank" rel="noopener"><h3>Process Explorer</h3><div class="sub" style="line-height:1.5">A far deeper Task Manager replacement from Microsoft's Sysinternals suite &mdash; inspect loaded DLLs, handles, and process trees.</div></a><a class="drive tool-card" href="https://learn.microsoft.com/en-us/sysinternals/downloads/autoruns" target="_blank" rel="noopener"><h3>Autoruns</h3><div class="sub" style="line-height:1.5">The definitive startup-entry inspector from Sysinternals &mdash; see and control everything set to launch with Windows, in far more depth than this report's own startup check.</div></a></div></div><div class="spec-section"><h2>Cleanup &amp; Disk Space</h2><div class="drive-grid"><a class="drive tool-card" href="https://www.bleachbit.org/" target="_blank" rel="noopener"><h3>BleachBit</h3><div class="sub" style="line-height:1.5">Clears temporary files and caches to free up disk space.</div></a><a class="drive tool-card" href="https://diskanalyzer.com/" target="_blank" rel="noopener"><h3>WizTree</h3><div class="sub" style="line-height:1.5">Visualises what's actually taking up space on a drive.</div></a></div></div><div class="spec-section"><h2>Driver Management</h2><div class="drive-grid"><div class="drive tool-card-group"><a class="tool-card-link" href="https://www.wagnardsoft.com/" target="_blank" rel="noopener"><h3>Display Driver Uninstaller (DDU)</h3><div class="sub" style="line-height:1.5">Fully removes GPU drivers before a clean reinstall &mdash; the standard fix for driver-related instability.</div></a><a class="tool-video-link" href="https://youtu.be/ULgWBAlgpfk" target="_blank" rel="noopener">&#9654; Watch tutorial</a></div><a class="drive tool-card" href="https://www.amd.com/en/support" target="_blank" rel="noopener"><h3>AMD Drivers &amp; Support</h3><div class="sub" style="line-height:1.5">Official AMD driver downloads.</div></a><a class="drive tool-card" href="https://www.nvidia.com/Download/index.aspx" target="_blank" rel="noopener"><h3>NVIDIA Drivers &amp; Support</h3><div class="sub" style="line-height:1.5">Official NVIDIA driver downloads.</div></a><a class="drive tool-card" href="https://www.intel.com/content/www/us/en/support/detect.html" target="_blank" rel="noopener"><h3>Intel Drivers &amp; Support</h3><div class="sub" style="line-height:1.5">Official Intel driver downloads.</div></a></div></div><div class="spec-section"><h2>Installation Media</h2><div class="drive-grid"><a class="drive tool-card" href="https://www.microsoft.com/software-download/windows11" target="_blank" rel="noopener"><h3>Windows 11 Download</h3><div class="sub" style="line-height:1.5">Official Microsoft page for Windows 11 installation media.</div></a><div class="drive tool-card-group"><a class="tool-card-link" href="https://rufus.ie/" target="_blank" rel="noopener"><h3>Rufus</h3><div class="sub" style="line-height:1.5">Creates bootable USB installers from a Windows ISO.</div></a><a class="tool-video-link" href="https://youtu.be/TiqcfvO_8Tc" target="_blank" rel="noopener">&#9654; Watch tutorial</a></div></div></div><div class="spec-section"><h2>Motherboard / BIOS Vendor Support</h2><div class="drive-grid"><a class="drive tool-card" href="https://www.asus.com/support/" target="_blank" rel="noopener"><h3>ASUS Support</h3><div class="sub" style="line-height:1.5">Official ASUS driver and BIOS downloads.</div></a><a class="drive tool-card" href="https://www.msi.com/support/" target="_blank" rel="noopener"><h3>MSI Support</h3><div class="sub" style="line-height:1.5">Official MSI driver and BIOS downloads.</div></a><a class="drive tool-card" href="https://www.gigabyte.com/Support" target="_blank" rel="noopener"><h3>Gigabyte Support</h3><div class="sub" style="line-height:1.5">Official Gigabyte driver and BIOS downloads.</div></a><a class="drive tool-card" href="https://www.asrock.com/support/index.asp" target="_blank" rel="noopener"><h3>ASRock Support</h3><div class="sub" style="line-height:1.5">Official ASRock driver and BIOS downloads.</div></a><a class="drive tool-card" href="https://www.dell.com/support/home/" target="_blank" rel="noopener"><h3>Dell Support</h3><div class="sub" style="line-height:1.5">Official Dell driver and BIOS downloads (by service tag).</div></a><a class="drive tool-card" href="https://support.hp.com/" target="_blank" rel="noopener"><h3>HP Support</h3><div class="sub" style="line-height:1.5">Official HP driver and BIOS downloads.</div></a><a class="drive tool-card" href="https://support.lenovo.com/" target="_blank" rel="noopener"><h3>Lenovo Support</h3><div class="sub" style="line-height:1.5">Official Lenovo driver and BIOS downloads.</div></a></div></div></div>
